...
// Simple elegant loading screen component
function Loader() {
  return (
    <motion.div
      initial={{ opacity: 1 }}
    ...
    >
      ...
      <p className="mt-4 text-sm font-semibold tracking-wider uppercase text-muted-foreground animate-pulse">
        Loading Ban Checker...
      </p>
    </motion.div>
  );
...
export default function BanChecker() {
  ...
  // Auto timeout loader simulation
  useEffect(() => {
  ...
  return (
    <>
      {/* AnimatePresence captures full exit transition of loader screen */}
      <AnimatePresence>
        {isLoading && <Loader />}
      </AnimatePresence>
