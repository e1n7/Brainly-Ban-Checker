    ...
    <header className="mb-6 flex items-center justify-between gap-4 overflow-visible px-1">
      <div className="flex min-w-0 items-center gap-5">
        <img
          ...
          alt="Brainly Logo"
          className="h-10 w-[128px] shrink-0 object-contain object-left select-none pointer-events-none"
        />
        <div className="min-w-0 border-l border-border pl-5">
          ...
          <p className="mt-1 max-w-xl text-xs leading-5 text-muted-foreground">Paste your text below and we&apos;ll check for banned words<br /> before you post. Stay safe and follow the rules!</p>
        </div>
      </div>
